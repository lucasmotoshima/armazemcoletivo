...
?>
			...
			<div id="main">
				...
				<!--==========================================-->
				<div id="titulo_dir"><label>Relatório de Imagens/Albuns</label></div>
				<div id="box_dir">
					<?$attributes = array('name' => 'imagemForm', 'id' => 'imagemForm','enctype'=>'multipart/form-data');?>
					<?=form_open('relatorio/imagem',$attributes,isset($hidden)?$hidden:'');?>
					<table class="grid">
						<tr>
							<th>Album</th>
							<th>Ativo</th>
						...
						<tr>
							<td><p><?=form_dropdown('fk_album',$fk_album,'','style="width:320px;"')?></p></td>
							<td><p><?=form_dropdown('ativo',$ativo,'','style="width:150px;"')?></p></td>
							<td><p><?=form_dropdown('isPrimary',$isPrimary,'','style="width:150px;"')?></p></td>
						</tr>
					</table>
				...
				<div id="box_dir">
					...
					<table class="grid">
						...
						<tr>
							<td><p><?=form_dropdown('fk_usuario',$fk_usuario,'','style="width:150px;"')?></p></td>
