			...
			jQuery.ajax({
				...
				success: function(returnedData){
					if(	returnedData.error == null || returnedData.error == '' || !returnedData.error || returnedData.error == false)
					{
						...
						$("#dt_end_installment").val(d.format('DD/MM/YYYY'));
			...
			<div class="col-md-12">
				...
				<div class="x_content">
						<div id='atributes'>
					        ...
					        <?}?>
							<div id='separator' class='plans'>Lista de Planos do Produtor</div>
							<div id='addIndustry'>
								<!--form action="<?=base_url('provider/addPlan/'.$provider[0]['id'])?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="providerPlanForm"-->
									<fieldset>
										<legend>Dados do Plano</legend>
										
										<div class="col-md-3 col-sm-3 col-xs-3 form-group">
											<label>Planos</label>
											<?=form_dropdown('plans',$plans,'','class="form-control" id="plans"')?>
										</div>
								...
								<div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<?if(count($provider['providerPlan'])>0){?>
										<fieldset>
											<legend>Dados do Plano - <?=(isset($provider[0]['name'])?$provider[0]['name']:'')?></legend>
											...
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Qtde. Meses de Pagto</label>
												<p><?=$provider['providerPlan'][0]['months_installment']?></p>
											</div>
											
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Valor Total</label>
												<p>R$ <?=$provider['providerPlan'][0]['price_total']?></p>
											</div>
											
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Tipo Pagamento</label>
												<p><?=($provider['providerPlan'][0]['tp_installment']=='1')?'à vista':'parcelado'?></p>
											</div>
											
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Data Início Pagamento</label>
												<p><?=$this->format_date->us2br($provider['providerPlan'][0]['dt_start_installment'])?></p>
											</div>
											
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Data Fim Pagamento</label>
												<p><?=$this->format_date->us2br($provider['providerPlan'][0]['dt_end_installment'])?></p>
											</div>
											
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Data Inicio Plano</label>
												<p><?=$this->format_date->us2br($provider['providerPlan'][0]['dt_start'])?></p>
											</div>
											
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Data Fim Plano</label>
												<p><?=$this->format_date->us2br($provider['providerPlan'][0]['dt_end'])?></p>
											</div>
											
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												<label>Obs</label>
												<p><?=$provider['providerPlan'][0]['obs']?></p>
											</div>
											
										</fieldset>
										
										<fieldset>
											<legend>Plano Original - <?=$plan[0]['name']?></legend>
											...
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Qtde. Períodos</label>
												<p><?=$plan[0]['period']?> <?=(($plan[0]['tp_period']=='month')?'meses':'')?></p>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Valor por Período</label>
												<p>R$ <?=$plan[0]['price_period']?></p>
											</div>
											<div class="col-md-2 col-sm-2 col-xs-2 form-group">
												<label>Preço Total</label>
												<p>R$ <?=$plan[0]['price_total']?></p>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12 form-group">
												<label>Descrição</label>
												<p></p>
