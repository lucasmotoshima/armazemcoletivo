...
class format_date {
	...
	function showCalendario($data, $tamanho=null){
		...
		$html =  (($data[0]=='0')?'<img src="'.base_url().'/public/images/icones/cal_dom'.(($tamanho=='peq')?'_peq':'').'.gif">':'<img src="'.base_url().'/public/images/icones/cinza'.(($tamanho=='peq')?'_peq':'').'.gif">')
				.(($data[0]=='1')?'<img src="'.base_url().'/public/images/icones/cal_seg'.(($tamanho=='peq')?'_peq':'').'.gif">':'<img src="'.base_url().'/public/images/icones/cinza'.(($tamanho=='peq')?'_peq':'').'.gif">')
