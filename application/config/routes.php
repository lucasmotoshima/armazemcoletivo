...
$route['cadastroprodutor'] = "Cadastroprodutor_controller";
$route['cadastroprodutor/([a-zA-Z]+)'] = "Cadastroprodutor_controller/$1";
$route['cadastroprodutor/([a-zA-Z]+)/([a-zA-Z0-9 ]+)'] = "Cadastroprodutor_controller/$1/$2";
$route['cadastroprodutor/([a-zA-Z]+)/([a-zA-Z0-9 ]+)/([a-zA-Z0-9 ]+)'] = "Cadastroprodutor_controller/$1/$2/$3";
