			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="row" style="margin-left: 0px;">
						<div class="col-lg-6">
							<b>Professor</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Professor Programação')).$tpservice['Professor Programação']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Professor Piano')).$tpservice['Professor Piano']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Professor Artesanato')).$tpservice['Professor Artesanato']?><br>
						</div>
						<div class="col-lg-6">
							<b>Serviços Médicos</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Médico da Família')).$tpservice['Médico da Família']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Enfermeira(o)')).$tpservice['Enfermeira(o)']?>
						</div>
					</div>
					<div class="row" style="margin-left: 0px;">
						<div class="col-lg-6">
							<b>Serviços de Salão</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Manicure/Pedicure')).$tpservice['Manicure/Pedicure']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Cabeleireira(o)')).$tpservice['Manicure/Pedicure']?><br>
						</div><br>
						<div class="col-lg-6">
							<b>Serviços Gerais</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Serviços residenciais')).$tpservice['Serviços residenciais']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Encanador')).$tpservice['Encanador']?>
						</div>
					</div>
					<div class="row" style="margin-left: 0px;">
						<div class="col-lg-6">
							<b>Terapeutas</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Psicóloga(o)')).$tpservice['Psicóloga(o)']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Terapeuta Ocupacional')).$tpservice['Terapeuta Ocupacional']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Coach')).$tpservice['Coach']?>
						</div><br>
						<div class="col-lg-6">
							<b>Entregas</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Entregas Delivery')).$tpservice['Entregas Delivery']?>
						</div>
					</div>
					<div class="row" style="margin-left: 0px;">
						<div class="col-lg-6">
							<b>Outros</b><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Fotógrafo')).$tpservice['Fotógrafo']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Cuidador de Idosos')).$tpservice['Cuidador de Idosos']?><br>
							<?=form_checkbox(array('name'=>'tp_service[]','id'=>'tp_service[]','value'=>'Cuidador de Crianças')).$tpservice['Cuidador de Crianças']?>
						</div>
					</div>
					<div class="row" style="margin-left: 0px;">
						<div class="col-lg-12">
							<b>Dia de Atendimento</b><br>
							<?='<small>Dom</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaDom')).'| <small>Seg</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaSeg')).'| <small>Ter</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaTer')).'| <small>Qua</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaQua')).'| <small>Qui</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaQui')).'| <small>Sex</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaSex')).'| <small>Sab</small> '.form_checkbox(array('name'=>'diaSemana[]','id'=>'diaSemana[]','value'=>'diaSemanaSab'));?>
						</div>
					</div>
